...
- **Share the win** primary action: generates a 1080×1080 felt brag card image (winner crest with their photo / monogram inside a laurel ring with a trophy badge, "wins." typography, final standings, game name, date) and presents the iOS share sheet. The user can send it via Messages, Mail, Photos, social apps, AirDrop, etc. The image is pre-rendered when the screen appears so a thumbnail is ready.
